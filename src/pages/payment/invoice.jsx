            ...
            <Layout>
                ...
                <div className="px-8 pt-6 pb-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
                        <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Invoice</h1>
                    </div>
                </div>
                        ...
                        <div className="relative overflow-hidden h-full">
                            <div className="overflow-x-auto h-[calc(100%-60px)]">
                                <main className="flex-1 p-8 overflow-auto">
                                    ...
                                    <h2 className="text-2xl font-bold text-[#101828] mb-6">Active Invoice</h2>
                                    <div className="border rounded-lg shadow-sm bg-white border-[#eaecf0]">
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-sm">
                                                ...
                                                <tbody>
                                                {employeeInvoiceData.map((employee, idx) => (
                                                    <tr key={idx} className="border-b border-[#eaecf0] last:border-0 hover:bg-[#f9fafb]">
                                                        ...
                                                        <td className="py-4 px-4 text-[#667085]">{employee.email}</td>
