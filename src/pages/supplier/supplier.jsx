    ...
    const suppliersData = [
        {
            ...
            contactNameShort: "Mr.Baker",
            email: "phoneix.baker@hotmail.com",
            address: "Minnesota",
            phone: "+1 8639724863",
                                                    ...
                                                    <tr key={idx} className="border-b border-[#eaecf0] last:border-0 hover:bg-[#f9fafb]">
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="font-medium text-[#101828]">{supplier.contactName}</span>
                                                            </div>
                                                        </td>
                                                        <td className="py-4 px-4 text-[#101828] font-medium">{supplier.id}</td>
                                                        <td className="py-4 px-4 text-[#667085]">{supplier.contactNameShort}</td>
                                                        <td className="py-4 px-4 text-[#667085]">{supplier.email}</td>
                                                        <td className="py-4 px-4 text-[#667085]">
                                                            <div className="flex items-center gap-2">
                                                                {supplier.addressShort || supplier.address}
                                                                <MoreHorizontal className="w-4 h-4 text-[#98a2b3]" />
                                                            </div>
                                                            {supplier.addressShort && (
                                                                <div className="text-xs text-[#98a2b3] mt-1">{supplier.address}</div>
                                                            )}
                                                        </td>
                                                        <td className="py-4 px-4 text-[#667085]">{supplier.phone}</td>
