...
export const SalesOrder = () => {
    ...
    const handleFormSubmit = async (formData) => {
        console.log("Submitted sale order data:", formData);
            ...
            <Layout>
                ...
                <div className="px-8 pt-6 pb-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
                        <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Sales Order</h1>
                        <div className="flex flex-wrap gap-2">
                            {timeRanges.map((range) => (
                                <button
                                    onClick={handleOpen} key={range}
                                            ...
                                            <table className="w-full text-sm">
                                                ...
                                                {salesOrderData.map((order, idx) => (
                                                    <tr key={idx} className="border-b border-[#eaecf0] last:border-0 hover:bg-[#f9fafb]">
                                                        ...
                                                        <td className="py-4 px-4 text-[#101828] font-medium">{order.salesOrderId}</td>
                                  ...
                                  {order.customerId}
                                                        ...
                                                        <td className="py-4 px-4 text-[#667085]">
                                                            {order.etd === "NA" ? (
                                                                ...
                                                                <div>
                                                                    <div>{order.etd}</div>
                                                                    <div className="text-xs text-[#98a2b3]">{order.etdTime}</div>
                                                                </div>
                                                            )}
                                                        </td>
                                                        <td className="py-4 px-4">
