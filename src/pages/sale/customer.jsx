                        ...
                        <div className="relative overflow-hidden h-full">
                            <div className="overflow-x-auto h-[calc(100%-60px)]">
                                <main className="flex-1 p-8 overflow-auto">
                                    ...
                                    <h2 className="text-2xl font-bold text-[#101828] mb-6">Active Customer</h2>
                                                    ...
                                                    <tr key={idx} className="border-b border-[#eaecf0] last:border-0 hover:bg-[#f9fafb]">
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="font-medium text-[#101828]">{customer.contactName}</span>
                                                            </div>
                                                        </td>
                                                        <td className="py-4 px-4 text-[#101828] font-medium">{customer.id}</td>
                                                        <td className="py-4 px-4 text-[#667085]">{customer.email}</td>
                                                        <td className="py-4 px-4 text-[#667085]">
                                                            <div className="flex items-center gap-2">
                                                                {customer.addressShort || customer.address}
                                                                <MoreHorizontal className="w-4 h-4 text-[#98a2b3]" />
                                                            </div>
                                                            {customer.addressShort && (
                                                                <div className="text-xs text-[#98a2b3] mt-1">{customer.address}</div>
                                                            )}
                                                        </td>
                                                        <td className="py-4 px-4 text-[#667085]">{customer.phone}</td>
